...
import org.androidpn.server.model.TtUser;
...
public class UserDaoHibernate extends HibernateDaoSupport implements UserDao {
    ...
    @SuppressWarnings("unchecked")
	public TtUser checkPassword(Long userID) throws Exception{
    	String hql="from TtUser where id=? and pwd is not null";
    	Object[] value={userID};
    	List<TtUser> ttUsers=super.getHibernateTemplate().find(hql,value);
    	if (null==ttUsers||ttUsers.isEmpty()) {
			return null;
		}
    	return ttUsers.get(0);
    }
}
