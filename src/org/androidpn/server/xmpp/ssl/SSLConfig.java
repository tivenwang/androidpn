...
public class SSLConfig {
    ...
    static {
        ...
        keyStoreLocation = classPath + File.separator+"WEB-INF"+File.separator+"classes"+ File.separator+ keyStoreLocation;
        ...
        trustStoreLocation = classPath+ File.separator +"WEB-INF"+File.separator+"classes"+ File.separator+trustStoreLocation;
